...
pub struct GateJumpedHandler {
    ctx: AppContext,
    emitter: Arc<Emitter<StoredGateJumped>>,
}

impl GateJumpedHandler {
    pub fn new(ctx: &AppContext, transports: Vec<Arc<dyn Transport<StoredGateJumped>>>) -> Self {
...
impl Handler for GateJumpedHandler {
    ...
    async fn commit<'a>(
        ...
        use crate::schema::events_gate_jumped::dsl::*;
