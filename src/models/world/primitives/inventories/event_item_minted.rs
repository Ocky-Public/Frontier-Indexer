...
use crate::schema::indexer::events_item_minted;

#[derive(Deserialize)]
pub struct MoveItemMinted {
...
#[diesel(table_name = events_item_minted)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct StoredItemMinted {
    pub event_id: String,
...
impl StoredItemMinted {
    pub fn from_event(event: &Event, meta: &EventMeta) -> Self {
        let move_event: MoveItemMinted =
            bcs::from_bytes(&event.contents).expect("Failed to deserialize Item Minted event");
