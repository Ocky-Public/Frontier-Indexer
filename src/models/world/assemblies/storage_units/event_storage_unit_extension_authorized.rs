...
use crate::schema::indexer::events_storage_unit_extension_authorized;

#[derive(Deserialize)]
pub struct MoveStorageUnitExtensionAuthorized {
...
#[diesel(table_name = events_storage_unit_extension_authorized)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct StoredStorageUnitExtensionAuthorized {
    pub event_id: String,
